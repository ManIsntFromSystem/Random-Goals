...
import com.quantumman.randomgoals.helpers.contracts.GoalsContract.DATABASE_NAME
import com.quantumman.randomgoals.helpers.contracts.GoalsContract.DATABASE_VERSION
...
class GoalDBOpenHelper internal constructor(context: Context?) :
    ...
    fun queryLists(id: Int?, inputName: String?): List<ParentListGoals> {
        val itemsGoalParentList: MutableList<ParentListGoals> = mutableListOf()
        ...
        while (cursor.moveToNext()) {
            ...
            val listNames = ParentListGoals(gid, name, icon)
            itemsGoalParentList.add(listNames)
        }
        return itemsGoalParentList.toList()
    }
