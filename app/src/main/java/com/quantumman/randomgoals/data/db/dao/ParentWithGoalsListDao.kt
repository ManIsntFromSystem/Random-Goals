...
import com.quantumman.randomgoals.helpers.contracts.DataContract.QUERY_GET_PARENT_WITH_GOALS_BY_ID
import io.reactivex.rxjava3.core.Flowable

@Dao
interface ParentWithGoalsListDao {
    @Transaction
    @Query(QUERY_GET_PARENT_WITH_GOALS_BY_ID)
    fun getParentWithList(parentId: Long): Flowable<ParentWithListGoalsDto>
